...
var _core = require("app/core/core");
...
_angular.default.module('grafana.directives').controller('YourComponentCtrl', ['$scope', function ($scope) {
  $scope.customer = {
    name: 'Naomi',
...
_angular.default.module('grafana.directives').directive("cool", function () {
  return {
