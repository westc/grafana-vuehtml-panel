define(["app/core/config","app/plugins/sdk","jquery","lodash"], function(__WEBPACK_EXTERNAL_MODULE_grafana_app_core_config__, __WEBPACK_EXTERNAL_MODULE_grafana_app_plugins_sdk__, __WEBPACK_EXTERNAL_MODULE_jquery__, __WEBPACK_EXTERNAL_MODULE_lodash__) { return /******/ (function(modules) { // webpackBootstrap
/******/ 	// The module cache
...
/*
 YourJS v2.21.0.gm - Your Very Own JS Library
...
(function (L, u, q) {
  ...
  function x(a) {
    return E.toString.call(a).slice(8, -1);
  }
  ...
  function F(a) {
    var c,
        b,
        d = x(a);
    return "Array" === d || !!a && !a.nodeName && "number" === typeof (c = a.length) && "Function" !== d && "String" !== d && (!c || 0 < c && 0 == (b = c - 1) % 1 && b in a);
  }
  ...
  function N(a, c, b) {
    if (F(a = Object(a))) {
      ...
      for (var e = 0, f = a.length; e < f; e++) {
        r(a, e) && c.call(b, a[e], e, a) && d.push(a[e]);
      }
    } else for (e in d = {}, a) {
      r(a, e) && c.call(b, a[e], e, a) && (d[e] = a[e]);
    }
  ...
  function G(a) {
    return arguments.length ? F(a) ? H(a) : [a] : [];
  }
  ...
  function J(a) {
    ...
    a.replace(/\?[^#]+/, function (a) {
      a.replace(/\+/g, " ").replace(/[\?&]([^=&#]+)(?:=([^&#]*))?/g, function (a, b, f, h, k, l) {
        b = decodeURIComponent(b);
        h = "[]" == b.slice(-2);
        f = f && decodeURIComponent(f);
        k = r(c, b);
        l = c[b];
        c[b] = h || k ? "Array" == z(l) ? l.concat([f]) : k ? [l, f] : [f] : f;
      });
    });
    return c;
  }
  ...
  function R(a, c, b) {
    return "number" == typeof a ? ("boolean" == typeof c && (b = c, c = q), c === q && (c = a, a = 0), a = Math.random() * (c - a) + a, b ? Math.trunc(a) : a) : a[R(0, a.length, 1)];
  }

  var v = this,
      E = {},
      w = v.document,
      r = D(E.hasOwnProperty, "call"),
      S;
  ...
  (function (a, c, b, d, e, f, h) {
      ...
      for (p in f) {
        if (r(f, p)) {
          ...
          if (p.indexOf("@media ")) {
            if ("Object" === l) {
              var p = p.replace(h, "$1");
              p = p.replace(e, function (a) {
                a = m ? a.replace(d, "& $&") : a;
                return m.replace(b, function (b) {
                  return a.replace(c, b);
                });
              });
              n.push(k(g, p));
            } else g = "Array" !== l ? g != q ? g && "number" == typeof g ? g + "px" : "!" == (g + "").slice(-1) ? g + "important" : g : "none" : g.join(","), p = p.replace(a, "-$&").toLowerCase(), t.push(p + ":" + g + ";");
          } else n.push(p + "{" + k(g, m) + "}");
        }
      }

      t[0] && n.unshift(m + "{" + t.join("") + "}");
      return n.join("");
    }
    ...
    S = function S(a, b) {
      ...
      d.type = "text/css";
      d.styleSheet && !d.sheet ? d.styleSheet.cssText = c : d.appendChild(w.createTextNode(c));
      (w.getElementsByTagName("head")[0] || w.body).appendChild(d);
      return d;
    };
  })(/[A-Z]/g, /&/g, /[^,]+|^$/g, /^[^&]+$/, /[^\s\xa0,][^,]*/g, /0(.|$)/, /^[\s\xa0]+|[\s\xa0]*(,)[\s\xa0]*|[\s\xa0]+$/g);

  eval("debounce231k=b;b=@;##b-k##@-b#throttle312#k=@,#k-b#b=k,#k-b#".replace(/(\D+)(.)(.)(.)([^#]*)#([^#]*)#([^#]*)#([^#]*)#([^#]*)#/g, "function $1(h,c,a){var u,d,e,f,g,k,b=0;a=u==a?$2:a?$3:$4;return function(){d=0;e=arguments;f=this;$5a&1&&($6d=$7>=c)&&($8g=h.apply(f,e));!d&&a&2&&setTimeout(function(){k=@,k-b>=c&&(b=k,g=h.apply(f,e))},c);return g}}").replace(/@/g, "+new Date"));
  var H = D([].slice, "call"),
      K,
      z;
  ...
  (function (a, c) {
    K = function K(b) {
      var d = P(b),
          e = [],
          f = E.toString.call(b).slice(8, -1);
      O(b) ? e.push("*primitive", f.toLowerCase()) : "Object" !== f && e.push("Object");
      b != q && e.push(f);
  ...
  (function (a, c, b, d) {
    ...
    _C = function C(f) {
      var h, k, l, m, n;
      if ("String" == z(f)) var t = H(_C({
        _: "DIV",
        html: f
      }).childNodes);else for (h in t = w.createElement(f.nodeName || f._), f) {
        var g = f[h];
        if (r(f, h) && "_" != (k = r(d, h) ? d[h] : h)) if ("style" == k) {
          var A = t[k];
          if ("String" == z(g)) A.cssText = g;else for (n in g) {
            r(g, n) && (A[n.replace(a, e)] = g[n]);
          }
        } else if (k == c || k == b) t[b] = t[c] = g;else if ("$" == k) for (g = G(g), A = 0, l = g.length; A < l;) {
          var p = G(_C(g[A++]));
          var u = 0;
        ...
        } else t[k] = g, k == h && t.getAttribute(k) == q && "function" != typeof g && t.setAttribute(k, g);
      }
      return t;
    };
  ...
  var B = {
    ...
    commaNumber: function commaNumber(a) {
      if (a = M(a)) return a = a.split("."), a[0] = a[0].replace(/\d(?=(\d{3})+$)/g, "$&,"), a.join(".");
    },
    ...
    formatTime: function formatTime(a, c) {
      var b,
          ...
          e = 0 > a || 0 > 1 / a;
      a = Math.abs(d(a));
      return c.replace(/(\\.)|'((?:[^']+|'')+)'|"((?:[^"]+|"")+)"|#((?:[^#]+|##)+)#|(\+)|(\-)|(([Ww])|([Dd])|(HH?|hh?)|(mm?)|(ss?)|(S(?:SS)?))(!)?/g, function (c, h, k, l, m, n, t, g, r, p, u, v, w, x, y) {
        if (h) return h;
        if (g) return b = c = x ? y ? a : a % 1E3 : w ? (c = d(a / 1E3), y ? c : c % 60) : v ? (c = d(a / 6E4), y ? c : c % 60) : u ? (c = d(a / 36E5), y ? c : c % 24) : p ? (c = d(a / 864E5), y ? c : c % 7) : d(a / 6048E5), g = g.length, y || 1 === g ? c : ("00" + c).slice(-g);
        k = k || l || m;
        return c = m ? "#" : l ? '"' : "'", ("#" === c && b != q ? k.replace(/\(((?:[^\\\|\(\)]|\\.)*)(?:\|((?:[^\\\|\(\)]|\\.)*))?\)/g, 1 === b ? "$2" : "$1") : k).split(c + c).join(c);
      }).replace(/\\(.)/g, "$1");
    },
    fullNumber: M,
    has: r,
    ...
    modURL: function modURL(a, c) {
      ...
      try {
        ...
        n = w.createElement("a"), n.href = d, d = new b(n.href);
      }
          ...
          if ("search" === e) {
            ...
            if ("object" === _typeof(b)) {
              var h = J(d[e]),
                  k = [];
              if (!f) for (var l in h) {
                r(h, l) && !r(b, l) && k.push([l, h[l]]);
              }

              for (var m in b) {
                r(b, m) && (f = b[m], f = "function" === typeof f ? f(h[m], h) : f, f != q && ("Array" === x(f) ? f : [f]).forEach(function (a) {
                  k.push([m, a]);
                }));
              }

              b = k.reduce(function (a, b) {
                return a + (a ? "&" : "?") + I(b[0]) + "=" + I(b[1]);
              }, "");
            }
          }

          d[e] = "function" === typeof b ? b(d[e]) : b;
        }
      }
    ...
    shuffle: function shuffle(a) {
      ...
      for (e = c; e;) {
        b = Math.round(Math.random() * --e), e && e != b && (c = d[e], d[e] = d[b], d[b] = c), r(a, d[e]) ? d[e] = a[d[e]] : delete d[e];
      }
    ...
    sub: function sub(a, c, b) {
      ...
      for (var d; d !== a; a = a.replace(/\{([\w\$]+)(?:\?((?:\\.|[^\\\{\}:])*):((?:\\.|[^\\\{\}:])*)(?::((?:\\.|[^\\\{\}:])*))?|#([\w\$]+))?\}/ig, function (a, d, h, k, l, m) {
        r(c, d) && (d = c[d], "function" == typeof d && (d = d(h, k, l, a)), a = h === q ? d : 1 == d ? k : d || l === q ? h : l, m != q && (m = m ? b[m] : b, "function" == typeof m && (a = m(a))));
        return a;
      })) {
        d = a;
      }
  ...
  [].forEach(function (a) {
   ...
   true ? ( true && module.exports && (exports = module.exports = B), (exports[u] = B)[u] = q) : undefined;
})("2.21.0.gm", "JS");

/***/ }),

/***/ "./external/dom-to-image.min.js":
/*!**************************************!*\
  !*** ./external/dom-to-image.min.js ***!
  \**************************************/
/*! no static exports found */
...
!function (a) {
  ...
  var q = m(),
   ...
   true ? module.exports = v : undefined;
}(this);
...
/* harmony import */ var _external_FileSaver_min_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./external/FileSaver.min.js */ "./external/FileSaver.min.js");
/* harmony import */ var _external_FileSaver_min_js__WEBPACK_IMPORTED_MODULE_3___default = /*#__PURE__*/__webpack_require__.n(_external_FileSaver_min_js__WEBPACK_IMPORTED_MODULE_3__);
/* harmony import */ var _external_YourJS_JS_min__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./external/YourJS.JS.min */ "./external/YourJS.JS.min.js");
/* harmony import */ var _external_YourJS_JS_min__WEBPACK_IMPORTED_MODULE_4___default = /*#__PURE__*/__webpack_require__.n(_external_YourJS_JS_min__WEBPACK_IMPORTED_MODULE_4__);
/* harmony import */ var _external_dom_to_image_min__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./external/dom-to-image.min */ "./external/dom-to-image.min.js");
/* harmony import */ var _external_dom_to_image_min__WEBPACK_IMPORTED_MODULE_5___default = /*#__PURE__*/__webpack_require__.n(_external_dom_to_image_min__WEBPACK_IMPORTED_MODULE_5__);
...
/* harmony import */ var _helper_functions__WEBPACK_IMPORTED_MODULE_6___default = /*#__PURE__*/__webpack_require__.n(_helper_functions__WEBPACK_IMPORTED_MODULE_6__);
/* harmony import */ var _external_vue_min__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./external/vue.min */ "./external/vue.min.js");
/* harmony import */ var _external_vue_min__WEBPACK_IMPORTED_MODULE_7___default = /*#__PURE__*/__webpack_require__.n(_external_vue_min__WEBPACK_IMPORTED_MODULE_7__);
/* harmony import */ var grafana_app_core_config__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! grafana/app/core/config */ "grafana/app/core/config");
/* harmony import */ var grafana_app_core_config__WEBPACK_IMPORTED_MODULE_8___default = /*#__PURE__*/__webpack_require__.n(grafana_app_core_config__WEBPACK_IMPORTED_MODULE_8__);
...
function getApiData(id, callback) {
  jquery__WEBPACK_IMPORTED_MODULE_9___default.a.ajax("/api/" + id, {
...
function (_super) {
  ...
  function SimpleCtrl($scope, $injector, $rootScope) {
    var _this = _super.call(this, $scope, $injector) || this; // Simple example showing the last value of all data


    _this.firstValues = [];
    _this.$rootScope = $rootScope;
    Object(lodash__WEBPACK_IMPORTED_MODULE_2__["defaultsDeep"])(_this.panel, DEFAULT_PANEL_SETTINGS); // If panel.emIsContentHeight was used, convert it to panel.emType.
  ...
  SimpleCtrl.prototype.onDataReceived = function (dataList) {
    var _this = this;
    ...
    if (dataList) {
      ...
      dataList.forEach(function (data) {
        var refId = data.refId,
            ...
            rows = data.rows;
        var datasetIndex = datasetNames_1.indexOf(refId);
        var dataset;

        if (data.type === 'table') {
          var colNames_1 = columns.map(function (c) {
            return 'string' === typeof c ? c : c.text;
          });
          _this.datasetsById[refId] = dataset = {
            columnNames: colNames_1,
            rows: rows.map(function (row) {
              return row.reduceRight(function (carry, cell, cellIndex) {
                carry[colNames_1[cellIndex]] = cell;
                return carry;
              }, {});
            }),
            raw: data
          ...
          dataset = _this.datasetsById[refId] = _this.datasetsById[refId] || {
          ...
          if (_external_YourJS_JS_min__WEBPACK_IMPORTED_MODULE_4__["typeOf"](dataset.raw) === 'Array') {
            dataset.raw.push(data);
          }
        }

        if (datasetIndex < 0) {
          datasetIndex = datasetNames_1.push(refId) - 1;
          _this.datasets[datasetIndex] = _this.dataset[datasetIndex] = dataset;
        }
      });
    }
  ...
  SimpleCtrl.prototype.onViewModeChanged = function () {
    this.logVueScope();
  };
  /**
  ...
  SimpleCtrl.prototype.onInitPanelActions = function (actions) {
    var tablesSubmenu = this.panelElement.find('table').toArray().reduce(function (carry, table, index) {
      if (jquery__WEBPACK_IMPORTED_MODULE_9___default()(table).is(SEL_DISABLE_DOWNLOAD_CSV)) {
        carry.push({
  ...
  SimpleCtrl.prototype.updateView = function () {
    var ctrl = this;
    var panel = ctrl.panel;
    var refreshRate = panel.refreshRate;
    var jElemPC = ctrl.panelElement;
    var elemPC = jElemPC[0];
    var elem = _external_YourJS_JS_min__WEBPACK_IMPORTED_MODULE_4__["dom"]({
      _: 'div'
    });
    ...
    var vueScopeData = _external_YourJS_JS_min__WEBPACK_IMPORTED_MODULE_4__["filter"](vueScope, function (value) {
      return 'function' !== typeof value;
    });
    var vueScopeMethods = Object(lodash__WEBPACK_IMPORTED_MODULE_2__["extend"])(_external_YourJS_JS_min__WEBPACK_IMPORTED_MODULE_4__["filter"](vueScope, function (value) {
      return 'function' === typeof value;
    }), {
    ...
    ctrl.stylesheet = _external_YourJS_JS_min__WEBPACK_IMPORTED_MODULE_4__["css"](JSON.parse(Object(_helper_functions__WEBPACK_IMPORTED_MODULE_6__["pseudoCssToJSON"])(panel.css)), "." + cls); // Add the randomized class name to the wrapper element while removing the
    ...
    if (myVue) {
      Object(lodash__WEBPACK_IMPORTED_MODULE_2__["extend"])(myVue.rawTemplate, templateValues);
    } else {
      jElemPC.html('').append(elem);
      myVue = ctrl.vue = new _external_vue_min__WEBPACK_IMPORTED_MODULE_7__({
        el: elem,
  ...
  SimpleCtrl.prototype.downloadJPEG = function () {
    var _this = this;

    _external_dom_to_image_min__WEBPACK_IMPORTED_MODULE_5___default.a.toJpeg(this.panelElement.find('div')[0], {
      quality: 0.85
    }).then(function (uri) {
      _external_YourJS_JS_min__WEBPACK_IMPORTED_MODULE_4__["dom"]({
        _: 'a',
        href: uri,
        download: _this.panel.title + _external_YourJS_JS_min__WEBPACK_IMPORTED_MODULE_4__["formatDate"](new Date(), " (YYYY-MM-DD 'at' H.mm.ss)") + '.screenshot.jpeg'
      }).click();
    });
  };

  SimpleCtrl.prototype.downloadPNG = function () {
    var _this = this;

    _external_dom_to_image_min__WEBPACK_IMPORTED_MODULE_5___default.a.toPng(this.panelElement.find('div')[0]).then(function (uri) {
      _external_YourJS_JS_min__WEBPACK_IMPORTED_MODULE_4__["dom"]({
        _: 'a',
        href: uri,
        download: _this.panel.title + _external_YourJS_JS_min__WEBPACK_IMPORTED_MODULE_4__["formatDate"](new Date(), " (YYYY-MM-DD 'at' H.mm.ss)") + '.screenshot.png'
      }).click();
    });
  };

  SimpleCtrl.prototype.downloadSVG = function () {
    var _this = this;

    _external_dom_to_image_min__WEBPACK_IMPORTED_MODULE_5___default.a.toSvg(this.panelElement.find('div')[0]).then(function (uri) {
      _external_YourJS_JS_min__WEBPACK_IMPORTED_MODULE_4__["dom"]({
        _: 'a',
        href: uri,
        download: _this.panel.title + _external_YourJS_JS_min__WEBPACK_IMPORTED_MODULE_4__["formatDate"](new Date(), " (YYYY-MM-DD 'at' H.mm.ss)") + '.screenshot.svg'
      }).click();
    });
  };

  SimpleCtrl.prototype.csvifyDataset = function (datasetIndex) {
    var data = this.dataset[datasetIndex];
    var columnNames = data.columnNames;
    var csvContent = Object(_helper_functions__WEBPACK_IMPORTED_MODULE_6__["toCSV"])(data.rows.map(function (row) {
    ...
    var fileName = this.panel.title + _external_YourJS_JS_min__WEBPACK_IMPORTED_MODULE_4__["formatDate"](new Date(), " (YYYY-MM-DD 'at' H.mm.ss)") + (".dataset-" + data.raw.refId + ".csv");
    Object(_external_FileSaver_min_js__WEBPACK_IMPORTED_MODULE_3__["saveAs"])(blob, fileName);
  };

  SimpleCtrl.prototype.csvifyTable = function (index) {
    var table = this.panelElement.find('table').toArray()[index];
    var title = table.getAttribute('data-title') || this.panel.title + (" Table " + (index + 1));
    var blob = new Blob([Object(_helper_functions__WEBPACK_IMPORTED_MODULE_6__["toCSV"])(Object(_helper_functions__WEBPACK_IMPORTED_MODULE_6__["tableToArray"])(table))], {
      type: 'text/csv;charset=utf-8'
    });
    var fileName = title + _external_YourJS_JS_min__WEBPACK_IMPORTED_MODULE_4__["formatDate"](new Date(), " (YYYY-MM-DD 'at' H.mm.ss)") + ".csv";
    Object(_external_FileSaver_min_js__WEBPACK_IMPORTED_MODULE_3__["saveAs"])(blob, fileName);
  };
  /**
  ...
  SimpleCtrl.prototype.logVueScope = function () {
    var _this = this; // If in editing mode show the html scope.


    if (this.panel.isEditing) {
      var interval_1 = setInterval(function (_) {
        if (_this.vue) {
          clearInterval(interval_1);
          console.log('Available data values:', _this.vue.rawTemplate.data);
          console.log('Available methods:', _this.vue.rawTemplate.methods);
        }
      }, 250);
    }
  };
  ...
  SimpleCtrl.prototype.getVueScope = function () {
    var ctrl = this;
    var result = Object(lodash__WEBPACK_IMPORTED_MODULE_2__["cloneDeep"])({
      allDashboards: [],
      dashboard: _external_YourJS_JS_min__WEBPACK_IMPORTED_MODULE_4__["filter"](ctrl.dashboard, function (value) {
        return _external_YourJS_JS_min__WEBPACK_IMPORTED_MODULE_4__["isPrimitive"](value);
      }),
      dataset: ctrl.dataset,
      datasets: ctrl.datasets,
      datasetsById: ctrl.datasetsById,
      panel: ctrl.panel.getOptionsToRemember(),
      JS: _external_YourJS_JS_min__WEBPACK_IMPORTED_MODULE_4__,
      themeType: grafana_app_core_config__WEBPACK_IMPORTED_MODULE_8___default.a.theme.type,
      url: {
        ...
        toParams: function toParams(objValues, opt_prefixVar) {
          ...
          return Object.entries(objValues).reduce(function (arrParams, _a) {
            var _b = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__read"])(_a, 2),
                key = _b[0],
                value = _b[1];

            return arrParams.concat(_external_YourJS_JS_min__WEBPACK_IMPORTED_MODULE_4__["toArray"](value).map(function (value) {
              return _this.encode((opt_prefixVar ? 'var-' : '') + key) + '=' + _this.encode(value);
            }));
          }, []).join('&');
        },
        getTimeValues: function getTimeValues(opt_name) {
          ...
          var _a = ctrl.timeSrv.timeRangeForUrl(),
              from = _a.from,
              to = _a.to;
        ...
        getVarValues: function getVarValues(opt_filter, opt_negate) {
          if (opt_filter && 'function' !== typeof opt_filter) {
            var arrFilter_1 = _external_YourJS_JS_min__WEBPACK_IMPORTED_MODULE_4__["toArray"](opt_filter);

            opt_filter = function opt_filter(key) {
              return arrFilter_1.some(function (filter) {
          ...
          return ctrl.templateSrv.variables.reduce(function (values, variable) {
            ...
            var varValues = _external_YourJS_JS_min__WEBPACK_IMPORTED_MODULE_4__["toArray"](variable.current.value);
      ...
      keyRows: function keyRows(rows, hasher) {
        ...
        return rows.reduce(function (carry, row) {
          var key = hasher(row);
          carry[key] = Object(lodash__WEBPACK_IMPORTED_MODULE_2__["has"])(carry, key) ? carry[key].concat([row]) : [row];
          return carry;
        }, {});
      },
      indexRows: function indexRows(rows, hasher) {
        ...
        var uniqueKeys = Object(lodash__WEBPACK_IMPORTED_MODULE_2__["uniq"])(keys);
        return rows.reduce(function (carry, row, rowIndex) {
          var realIndex = uniqueKeys.indexOf(keys[rowIndex]);
          carry[realIndex] = Object(lodash__WEBPACK_IMPORTED_MODULE_2__["has"])(carry, realIndex) ? carry[realIndex].concat([row]) : [row];
          return carry;
        }, []);
      }
    });
  ...
  SimpleCtrl.prototype.renderError = function (title, message, isMonospace) {
    this.panelElement.html('').append(_external_YourJS_JS_min__WEBPACK_IMPORTED_MODULE_4__["dom"]({
      _: 'div',
      style: {
        display: 'flex',
        alignItems: 'center',
...
/* harmony default export */ __webpack_exports__["default"] = (SimpleCtrl); // Allows for error handling in vueToHTML().

_external_vue_min__WEBPACK_IMPORTED_MODULE_7__["config"].errorHandler = function (err, vm, info) {
  if (vm && vm.onError) {
    vm.onError(err, info);
  }
};
